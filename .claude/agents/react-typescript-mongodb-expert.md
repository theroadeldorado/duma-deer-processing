...
description: "Use this agent when implementing features, debugging issues, refactoring code, or answering questions about React, TypeScript, Next.js (Pages Router), MongoDB/Mongoose, and Firebase Auth in this deer processing application. This agent understands the project's architecture including the form wizard, pricing system, and admin management patterns.\\n\\nExamples:\\n\\n<example>\\nContext: The user wants to add a new processing option to the deer check-in form.\\nuser: \"Add a new option for smoked sausage to the products\"\\nassistant: \"I'll use the react-typescript-mongodb-expert agent to implement this new product option following the established patterns.\"\\n<Task tool call to launch react-typescript-mongodb-expert agent>\\n</example>\\n\\n<example>\\nContext: The user is experiencing a bug with price calculations.\\nuser: \"The total price is showing incorrectly for orders with cape and hide\"\\nassistant: \"Let me use the react-typescript-mongodb-expert agent to debug this pricing issue in the price calculation system.\"\\n<Task tool call to launch react-typescript-mongodb-expert agent>\\n</example>\\n\\n<example>\\nContext: The user wants to create a new API endpoint.\\nuser: \"I need an API endpoint to export orders to CSV\"\\nassistant: \"I'll use the react-typescript-mongodb-expert agent to create this new secure API endpoint following the project's secureApi patterns.\"\\n<Task tool call to launch react-typescript-mongodb-expert agent>\\n</example>\\n\\n<example>\\nContext: The user asks a question about the codebase architecture.\\nuser: \"How does the form wizard handle step skipping?\"\\nassistant: \"I'll use the react-typescript-mongodb-expert agent to explain the form wizard's step skipping logic.\"\\n<Task tool call to launch react-typescript-mongodb-expert agent>\\n</example>\\n\\n<example>\\nContext: The user wants to add a new field to the deer order.\\nuser: \"Add a field for customer phone number to the order form\"\\nassistant: \"I'll use the react-typescript-mongodb-expert agent to add this field across the type definitions, form components, and Mongoose schema.\"\\n<Task tool call to launch react-typescript-mongodb-expert agent>\\n</example>"
model: opus
color: green
---
